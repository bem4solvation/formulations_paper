...
preconditioner = bem_electrostatics.pb_formulation.formulations.lhs.laplace_multitrace(protein.dirichl_space, protein.neumann_space, protein.operator_assembler)
protein.matrices["preconditioning_matrix"] = bem_electrostatics.pb_formulation.preconditioning.first_kind_interior_scaled_mass(protein.dirichl_space, protein.ep_in, protein.ep_ex, preconditioner) * preconditioner.weak_form()

protein.matrices["A_discrete"] = protein.matrices["preconditioning_matrix"] * protein.matrices["A"].strong_form()
...
protein.rhs["rhs_discrete"] = protein.matrices["preconditioning_matrix"] * bem_electrostatics.solute.rhs_to_discrete_form(protein.rhs["rhs_final"], protein.discrete_form_type, protein.matrices["A"])
